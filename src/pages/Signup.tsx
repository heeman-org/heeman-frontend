        ...
        <div className="min-h-screen bg-white flex items-center justify-center p-6 pt-32">
            ...
            >
                <div className="text-center mb-10">
                    <h1 className="text-4xl font-display font-bold tracking-tight mb-3">Join HeMan</h1>
                    <p className="text-primary/60 text-sm italic">Create an account to start your journey</p>
                </div>
